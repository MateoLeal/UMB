...
<div class="w3-main w3-white w3-container w3-card w3-margin-bottom" style="margin-left:270px; padding-bottom: 20px;">
    ...
    <div class="w3-row" style="margin-top:20px">
        <form action="" method="post" enctype="multipart/form-data">
            <input type="hidden" name="r" value="usuario&amp;CrearUsu&amp;">
    ...
    <div class="w3-row">
        <center>
            <table style="width:35%;" class="table table-striped table-hover" id="tabla">
                <thead>
                    <tr>
                        <th class="w3-red w3-center" style="width: 5%">ID</th>
                        <th class="w3-red" style="width: 20%">Usuario</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="r" value="usuario&amp;EditarUsu&amp;">
                            ...
                            <td>
                                <form action="" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?php echo $r->id; ?>">
                                    <input type="hidden" name="r" value="usuario&amp;Eliminar&amp;">
